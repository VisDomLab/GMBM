...
male_keywords = ['man', 'boy', 'male', 'gentleman', 'guy', 'father', 'husband', 'brother', 'grandfather', 'he', 'him', 'his']
female_keywords = ['woman', 'girl', 'female', 'lady', 'mother', 'wife', 'sister', 'grandmother', 'she', 'her']
# Select two object categories for bias
bias_category_1 = ['sports ball', 'baseball bat', 'skateboard']
bias_category_2 = ['oven', 'refrigerator', 'sink']
